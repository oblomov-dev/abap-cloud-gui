CLASS zdev_cl_selscreen_app_demo DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC INHERITING FROM zacgui_cl_program.

  PUBLIC SECTION.
    METHODS on_event REDEFINITION.
    METHODS on_init REDEFINITION.
    METHODS on_navigated REDEFINITION.
    METHODS on_definintion REDEFINITION.
    METHODS on_value_help REDEFINITION.
*    DATA mv_arbgb TYPE t100-arbgb.
    DATA mv_date TYPE d.
    DATA mv_value TYPE string.
    DATA mv_flag TYPE abap_bool.
    DATA so_matnr TYPE RANGE OF matnr.
*    DATA so_kunnr TYPE RANGE OF kunnr.
...
CLASS zdev_cl_selscreen_app_demo IMPLEMENTATION.
